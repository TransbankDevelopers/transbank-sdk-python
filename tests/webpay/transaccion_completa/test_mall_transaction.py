...
class TransactionMallTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.details = [{"commerce_code": "commerce123", "buy_order": "order123", "amount": 1000, "installments_number": 1}]
        self.mock_response = Mock()
        self.transaction = MallTransaction.build_for_integration(IntegrationCommerceCodes.TRANSACCION_COMPLETA_MALL, IntegrationApiKeys.WEBPAY)
